...
// wired connections
#define HG7881_B_IA 4 // D4 --> Motor B Input A --> MOTOR B +
#define HG7881_B_IB 5 // D5 --> Motor B Input B --> MOTOR B -
...
void loop()
{
  ...
  Serial.println( "2) Soft stop (coast)" );
  //Serial.println( "4) Reverse" );
  Serial.println( "3) Fast reverse" );
